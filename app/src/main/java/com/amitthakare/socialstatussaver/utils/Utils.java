...
public class Utils {
    ...
    public static File downloadWhatsAppDir = new File(Environment.getExternalStorageDirectory() + "/Download/SocialStatusSaver/Whatsapp");
    public static File downloadWABusiDir = new File(Environment.getExternalStorageDirectory() + "/Download/SocialStatusSaver/WABusiness");

    public static String instaDirPath = "SocialStatusSaver/Instagram/";
    public static File downloadInstaDir = new File(Environment.getExternalStorageDirectory() + "/Download/SocialStatusSaver/Instagram");

    public static String twitterDirPath = "SocialStatusSaver/Twitter/";
    public static File downloadTwitterDir = new File(Environment.getExternalStorageDirectory() + "/Download/SocialStatusSaver/Twitter");

    public static File downloadLikeeDir = new File(Environment.getExternalStorageDirectory() + "/Download/SocialStatusSaver/Likee");

    public static String tiktokDirPath = "SocialStatusSaver/Tiktok/";
    public static File downloadTiktokDir = new File(Environment.getExternalStorageDirectory() + "/Download/SocialStatusSaver/Tiktok");

    public static String fbDirPath = "SocialStatusSaver/Facebook/";
    public static File downloadFBDir = new File(Environment.getExternalStorageDirectory() + "/Download/SocialStatusSaver/Facebook");
